...
Reuse [claims and references](contracts.md), [capability profile](capability-profile.md) and [discovery rules](../rules/discovery.md). This is a semantic output contract, not a job tracker.
